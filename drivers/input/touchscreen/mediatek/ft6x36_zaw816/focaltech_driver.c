...
reset_proc:
 ...
 //   tpd_mstar_status =0 ;  // compatible mstar and ft6306 chenzhecong
...
#ifdef FTS_GESTRUE
	//init_para(480,854,60,0,0);   modify by taoxiaodong
	...
	__set_bit(KEY_GESTURE_CC, tpd->dev->keybit);
...
//wangcq327 add end
...
#endif
	{
		...
		//i2c_smbus_write_i2c_block_data(i2c_client, 0xA5, 3, &data);  //TP enter sleep mode	
		mutex_unlock(&i2c_access);
		msleep(10);  //modify by taoxiaodong	
	#endif
