...
#else
#define TPD_POWER_SOURCE_CUSTOM         PMIC_APP_CAP_TOUCH_VDD // MT6325_POWER_LDO_VGP1
#endif
...
#define TPD_BUTTON_HEIGH        (45)  //100
#define TPD_KEY_COUNT           3    //  4
#define TPD_KEYS                { KEY_BACK, KEY_HOMEPAGE, KEY_MENU }
#define TPD_KEYS_DIM            	{{80,1340,50,TPD_BUTTON_HEIGH}, {350,1340,50,TPD_BUTTON_HEIGH}, {630,1340,50,TPD_BUTTON_HEIGH}}
