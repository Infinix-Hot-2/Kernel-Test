...
static unsigned char CTPM_FW1[] = {
	#include "FT5346_HQ_AW700_DJ_V07_D03_20150626_app.i"
};

static unsigned char CTPM_FW2[] = {
	#include "FT5346_AW700_HQ_Oflim_V14_D02_20150626_app.i"
};
/*
upgrade with *.i file
*/
...
u8 fts_dj_ctpm_get_i_file_ver(void)
{
	u16 ui_sz;
...
//	 printk("[FTS] uc_tp_vendor_id = 0x%x, uc_host_vendor_id = 0x%x\n",uc_tp_vendor_id, uc_host_vendor_id);
    // if(uc_tp_vendor_id!=uc_host_vendor_id)return 0;
       ...
       {
		uc_host_fm_ver = fts_dj_ctpm_get_i_file_ver();
       }  	
