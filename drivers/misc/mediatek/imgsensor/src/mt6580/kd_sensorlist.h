...
UINT32 OV8858_MIPI_RAW_AW816_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//add by Tony.G
...
UINT32 OV5670_MIPI_RAW_HQ_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //change by wangyang for two camera 20150416
UINT32 OV5670_MIPI_RAW_QH_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //change by wangyang for two camera 20150416
...
// tangqingcai 0310 mipi yuv
UINT32 GC0310MIPI_YUV_HQ_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //change by wangyang for two camera 20150416
UINT32 GC0310MIPI_YUV_QH_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //change by wangyang for two camera 20150416
...
#if  defined(OV8858_MIPI_RAW_GZ_ZAW806)
    {OV8858_SENSOR_ID, SENSOR_DRVNAME_OV8858_MIPI_RAW,OV8858_MIPI_RAW_SensorInit},
#endif

#if defined(OV8858_MIPI_RAW_ZAW816) 
    {OV8858_AW816_SENSOR_ID, SENSOR_DRVNAME_OV8858_MIPI_RAW_AW816,OV8858_MIPI_RAW_AW816_SensorInit},//add by Tony.G
#endif
...
#if defined(OV5670_MIPI_RAW_QH)
    {OV5670MIPI_QH_SENSOR_ID, SENSOR_DRVNAME_OV5670_QH_MIPI_RAW, OV5670_MIPI_RAW_QH_SensorInit}, //change by wangyang for two camera 20150416
#endif

#if defined(OV5670_MIPI_RAW_HQ)
    {OV5670MIPI_HQ_SENSOR_ID, SENSOR_DRVNAME_OV5670_HQ_MIPI_RAW, OV5670_MIPI_RAW_HQ_SensorInit}, //change by wangyang for two camera 20150416
#endif
...
#if defined(GC0310_MIPI_YUV_QH)
    {GC0310_QH_SENSOR_ID, SENSOR_DRVNAME_GC0310_QH_MIPI_YUV,GC0310MIPI_YUV_QH_SensorInit},//change by wangyang for two camera 20150416
#endif

#if defined(GC0310_MIPI_YUV_HQ)
    {GC0310_HQ_SENSOR_ID, SENSOR_DRVNAME_GC0310_HQ_MIPI_YUV,GC0310MIPI_YUV_HQ_SensorInit},//change by wangyang for two camera 20150416
#endif
