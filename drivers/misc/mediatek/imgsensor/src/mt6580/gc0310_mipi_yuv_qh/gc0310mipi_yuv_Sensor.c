...
static gc0310MIPI_initial_set_struct gc0310MIPI_Init_Reg[5000];
...
static void GC0310MIPI_Sensor_Init(void)
{
  ...
  /////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x41,0x21);//21->25
	...
	GC0310MIPI_write_cmos_sensor(0x77, 0x72);//65
	GC0310MIPI_write_cmos_sensor(0x78, 0x43);//40
	GC0310MIPI_write_cmos_sensor(0x79, 0x55);//68
	
	///////////////////////////////////////////////// 
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
  GC0310MIPI_write_cmos_sensor(0x80,0x00); //c1
  GC0310MIPI_write_cmos_sensor(0x82,0x10); //14//10//06   
  GC0310MIPI_write_cmos_sensor(0x83,0x20); //0b 
  GC0310MIPI_write_cmos_sensor(0x86,0x30);
  GC0310MIPI_write_cmos_sensor(0x87,0x20);
  GC0310MIPI_write_cmos_sensor(0x88,0x10);
  GC0310MIPI_write_cmos_sensor(0x89,0x20);//f0 
  GC0310MIPI_write_cmos_sensor(0x8c,0x08);//0b//10
  GC0310MIPI_write_cmos_sensor(0x8d,0x10);//20//2f
	
	///////////////////////////////////////////////// 
	//////////////////   EEINTP  ////////////////////
	///////////////////////////////////////////////// 
	GC0310MIPI_write_cmos_sensor(0x8f,0xaa); 
	GC0310MIPI_write_cmos_sensor(0x90,0x08); //8c
	GC0310MIPI_write_cmos_sensor(0x91,0x10);//90
	GC0310MIPI_write_cmos_sensor(0x92,0x88); //03
	GC0310MIPI_write_cmos_sensor(0x93,0x0a); //03
	GC0310MIPI_write_cmos_sensor(0x94,0x8a);//05 
	...
	GC0310MIPI_write_cmos_sensor(0x9b,0xf0);//80
	GC0310MIPI_write_cmos_sensor(0x9c,0x40);
	GC0310MIPI_write_cmos_sensor(0x9d,0x50);  //80
	 
	GC0310MIPI_write_cmos_sensor(0xa1,0x30);
 	GC0310MIPI_write_cmos_sensor(0xa2,0x22); //32
	GC0310MIPI_write_cmos_sensor(0xa4,0x50);//30 14->50
	GC0310MIPI_write_cmos_sensor(0xa5,0x10);//30  26->10
	GC0310MIPI_write_cmos_sensor(0xaa,0x40); //10
	GC0310MIPI_write_cmos_sensor(0xac,0x33); //22
	GC0310MIPI_write_cmos_sensor(0xad,0x30);
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0x0c,0x40);//00->40 red
	GC0310MIPI_write_cmos_sensor(0x12,0x52); 
    GC0310MIPI_write_cmos_sensor(0x13,0x40);//38
	GC0310MIPI_write_cmos_sensor(0x18,0x95); 
	GC0310MIPI_write_cmos_sensor(0x19,0x96); 
	GC0310MIPI_write_cmos_sensor(0x1f,0x40); //20 red 20150513
	GC0310MIPI_write_cmos_sensor(0x20,0xe0); //co red 20150513
	...
	GC0310MIPI_write_cmos_sensor(0x67,0x83);//a2
	GC0310MIPI_write_cmos_sensor(0x69,0x08);
	GC0310MIPI_write_cmos_sensor(0x6a,0x05);
	GC0310MIPI_write_cmos_sensor(0x6b,0x00);//01 red 20150513
	...
	GC0310MIPI_write_cmos_sensor(0x96,0xe6);
	GC0310MIPI_write_cmos_sensor(0x97,0x46);
	GC0310MIPI_write_cmos_sensor(0x98,0x1d);
	GC0310MIPI_write_cmos_sensor(0x9a,0x47);
	GC0310MIPI_write_cmos_sensor(0x9b,0x1d);
	GC0310MIPI_write_cmos_sensor(0x9c,0xc2);
	GC0310MIPI_write_cmos_sensor(0x9d,0x48);
	...
	GC0310MIPI_write_cmos_sensor(0xab,0x9b);
	GC0310MIPI_write_cmos_sensor(0xac,0x7b);
	GC0310MIPI_write_cmos_sensor(0xae,0xc0);
	GC0310MIPI_write_cmos_sensor(0xaf,0x9c);
	GC0310MIPI_write_cmos_sensor(0xb0,0xc4);
	GC0310MIPI_write_cmos_sensor(0xb1,0x8f);
	...
	GC0310MIPI_write_cmos_sensor(0xb8,0xca);
	GC0310MIPI_write_cmos_sensor(0xb9,0x9c);
*/
	GC0310MIPI_write_cmos_sensor(0xfe,0x01);
	GC0310MIPI_write_cmos_sensor(0x90,0xc9);
	GC0310MIPI_write_cmos_sensor(0x91,0xbe);
	GC0310MIPI_write_cmos_sensor(0x92,0xe6);
	GC0310MIPI_write_cmos_sensor(0x93,0xca);
	GC0310MIPI_write_cmos_sensor(0x95,0x1d);
	GC0310MIPI_write_cmos_sensor(0x96,0xe6);
	...
	GC0310MIPI_write_cmos_sensor(0x9b,0x1d);
	GC0310MIPI_write_cmos_sensor(0x9c,0xc2);
	GC0310MIPI_write_cmos_sensor(0x9d,0x45);
	GC0310MIPI_write_cmos_sensor(0x9f,0xc7);
	GC0310MIPI_write_cmos_sensor(0xa0,0xc8);
	GC0310MIPI_write_cmos_sensor(0xa1,0x00);
	GC0310MIPI_write_cmos_sensor(0xa2,0x00);
	...
	GC0310MIPI_write_cmos_sensor(0xa6,0xb8);
	GC0310MIPI_write_cmos_sensor(0xa7,0x95);
	GC0310MIPI_write_cmos_sensor(0xa9,0xd7);
	GC0310MIPI_write_cmos_sensor(0xaa,0x95);
	GC0310MIPI_write_cmos_sensor(0xab,0x9b);
	GC0310MIPI_write_cmos_sensor(0xac,0x7b);
	GC0310MIPI_write_cmos_sensor(0xae,0xc0);
	...
	GC0310MIPI_write_cmos_sensor(0xb7,0x05);
	GC0310MIPI_write_cmos_sensor(0x8f,0x00);
	GC0310MIPI_write_cmos_sensor(0xb8,0xc9);
	GC0310MIPI_write_cmos_sensor(0xb9,0x9e);
	/////////////////////////////////////////////////
	////////////////////   CC    ////////////////////
	/////////////////////////////////////////////////
	GC0310MIPI_write_cmos_sensor(0xfe,0x01);
                                 
  /*GC0310MIPI_write_cmos_sensor(0xd0,0x38);//skin red
...
*/
GC0310MIPI_write_cmos_sensor(0xd0, 0x30);//35 red
GC0310MIPI_write_cmos_sensor(0xd1, 0xfd);//fe red f8
GC0310MIPI_write_cmos_sensor(0xd2, 0x06);//08
GC0310MIPI_write_cmos_sensor(0xd3, 0xf8);
GC0310MIPI_write_cmos_sensor(0xd4, 0x40);
GC0310MIPI_write_cmos_sensor(0xd5, 0x04);
GC0310MIPI_write_cmos_sensor(0xd6, 0x40);
GC0310MIPI_write_cmos_sensor(0xd7, 0x04);
GC0310MIPI_write_cmos_sensor(0xd8, 0x0a);
GC0310MIPI_write_cmos_sensor(0xd9, 0x16);
GC0310MIPI_write_cmos_sensor(0xda, 0x36);
GC0310MIPI_write_cmos_sensor(0xdb, 0xf6);
	...
	GC0310MIPI_write_cmos_sensor(0xc4,0x6d);//78 red 20150513
	GC0310MIPI_write_cmos_sensor(0xc5,0x43);//40 red 20150513
	GC0310MIPI_write_cmos_sensor(0xc6,0x40);//40 red 20150513
	GC0310MIPI_write_cmos_sensor(0xc7,0x08);//28 red 20150513
	GC0310MIPI_write_cmos_sensor(0xc8,0x02);
	...
	GC0310MIPI_write_cmos_sensor(0x2b,0x04); //7.14fps //5cc red 20150521
	GC0310MIPI_write_cmos_sensor(0x2c,0xf8); 
	...
	//////////////////autogray///////
        GC0310MIPI_write_cmos_sensor(0xde,0xe5);
	/////////////////////////////////////////////////
	///////////////////   MIPI	 ////////////////////
	/////////////////////////////////////////////////
	GC0310MIPI_write_cmos_sensor(0xfe,0x03);
...
{
    int  retry = 3; 
    mt_set_gpio_mode(GPIO_SUB_CAM_ID_PIN,GPIO_SUB_CAM_ID_PIN_M_GPIO);
	mt_set_gpio_dir(GPIO_SUB_CAM_ID_PIN,GPIO_DIR_IN);
		/***qunhui camera ***/
	SENSORDB("[camera][wangyang]GPIO_SUB_CAM_ID_PIN：%d \r\n",mt_get_gpio_in(GPIO_SUB_CAM_ID_PIN));
	if(!mt_get_gpio_in(GPIO_SUB_CAM_ID_PIN)) //high:qunhui low:huaquan
	{
		SENSORDB("[camera][wangyang]GPIO_SUB_CAM_ID_PIN：high,is not <qunhui> camera !!!");
		*sensorID = 0xFFFFFFFF;
    ...
    do {
        *sensorID=((GC0310MIPI_read_cmos_sensor(0xf0)<< 8)|GC0310MIPI_read_cmos_sensor(0xf1));
        if (*sensorID == GC0310_QH_SENSOR_ID)
            break; 
...
static UINT32 GC0310MIPIOpen(void)
{
	...
	printk("<cj> Entry GC0310MIPIOpen!!!\r\n");
	...
	for(i=0;i<3;i++)
	{
		...
		if(sensor_id != GC0310_QH_SENSOR_ID)  
		{
	...
	GC0310MIPI_Sensor_Init();
	printk("this is gc0310_qunhui module\n");
#ifdef DEBUG_SENSOR_GC0310MIPI  
		struct file *fp; 
		mm_segment_t fs; 
		loff_t pos = 0; 
...
static BOOL GC0310MIPI_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
			...
			GC0310MIPI_write_cmos_sensor(0x77, 0x80); //WB_manual_gain 
			GC0310MIPI_write_cmos_sensor(0x78, 0x43);
			GC0310MIPI_write_cmos_sensor(0x79, 0x50);
		break;
		
		case AWB_MODE_DAYLIGHT: //sunny
			GC0310MIPI_awb_enable(KAL_FALSE);
			GC0310MIPI_write_cmos_sensor(0x77, 0x68); 
		...
		case AWB_MODE_INCANDESCENT: //office
			...
			GC0310MIPI_write_cmos_sensor(0x78, 0x4c);
			GC0310MIPI_write_cmos_sensor(0x79, 0xf0);
		break;
		...
		case AWB_MODE_FLUORESCENT:
			GC0310MIPI_awb_enable(KAL_FALSE);
			GC0310MIPI_write_cmos_sensor(0x77, 0x6a);
			GC0310MIPI_write_cmos_sensor(0x78, 0x42);
			GC0310MIPI_write_cmos_sensor(0x79, 0x5f);
		break;
...
static BOOL GC0310MIPI_set_param_banding(UINT16 para)
{
	 switch (para)
	 {
		 case AE_FLICKER_MODE_50HZ:
			 ...
			 GC0310MIPI_write_cmos_sensor(0x28, 0x12); 
			 GC0310MIPI_write_cmos_sensor(0x29, 0x02);	 //exp level 1	12.50fps
			 GC0310MIPI_write_cmos_sensor(0x2a, 0x7c); 
			 GC0310MIPI_write_cmos_sensor(0x2b, 0x04); //7.14fps //5cc red 20150515
			 GC0310MIPI_write_cmos_sensor(0x2c, 0x24); 
			 GC0310MIPI_write_cmos_sensor(0x2d, 0x05);	 //exp level 3	5.55fps
			 GC0310MIPI_write_cmos_sensor(0x2e, 0xcc); 
			 GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			 break;
...
static BOOL GC0310MIPI_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		case AE_EV_COMP_n30:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x0d);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		...
		case AE_EV_COMP_n25:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x10);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;		
		case AE_EV_COMP_n20:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x1d);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_n15:
			...
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			//GC0310MIPI_write_cmos_sensor(0xd5, 0xd0);
			//mdelay(500);
		break;
		
		case AE_EV_COMP_n10:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x2d);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		...
		case AE_EV_COMP_00:		
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x3d);//35
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			//mdelay(500);
		break;
		...
		case AE_EV_COMP_20:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x70);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;
		
		case AE_EV_COMP_25:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x80);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_30:
			...
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			//GC0310MIPI_write_cmos_sensor(0xd5, 0x20);
			//mdelay(500);
		break;
		...
		case AE_EV_COMP_n32:
			...
			//GC0310MIPI_write_cmos_sensor(0xd5, 0xd0);
			mdelay(500);
			printk("HUANG ------>>>> para = n32 %d\n",para);
		break;
		case AE_EV_COMP_n34:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x0c, 0x00);
			GC0310MIPI_write_cmos_sensor(0x13, 0x4d);//35
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			mdelay(500);
			printk("HUANG ------>>>> para = n34 %d\n",para);
		break;
		case AE_EV_COMP_n36:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x0c, 0x00);
			GC0310MIPI_write_cmos_sensor(0x13, 0xa0);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			//GC0310MIPI_write_cmos_sensor(0xd5, 0x20);
			mdelay(500);
			printk("HUANG ------>>>> para = n36 %d\n",para);
		break;
...
static void GC0310_QH_MIPI_get_AEAWB_lock(UINT32 *pAElockRet32,UINT32 *pAWBlockRet32)
{ 
    *pAElockRet32 = 1;
    *pAWBlockRet32 = 1;
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_SET_YUV_CMD:
        GC0310MIPIYUVSensorSetting((FEATURE_ID)*pFeatureData16, (UINT16)*(feature_data+1));
        break;
   ...
   case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO: 
		...
		GC0310_QH_MIPI_get_AEAWB_lock((UINT32)*(feature_data),(UINT32)*(feature_data+1));	
	break; 
    default:
        break; 
	}
...
static SENSOR_FUNCTION_STRUCT	SensorFuncGC0310MIPIYUV=
{
	GC0310MIPIOpen,
	GC0310MIPIGetInfo,
	GC0310MIPIGetResolution,
...
UINT32 GC0310MIPI_YUV_QH_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
