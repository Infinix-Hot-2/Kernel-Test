...
#define OV8858R2AOTP //add yuyan 20150617
...
OV8858_VERSION ov8858version2 = OV8858R2A;

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = OV8858_AW816_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
//  ;;
	...
	if (ov8858version2 == OV8858R1A){
		LOG_INF("inter r1asensor_init() ov8858version2 = %d(0=r2a,1=r1a)\n",ov8858version2); 
		r1asensor_init();
	}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	kal_uint8 retry = 2;
	   ...
	   if((read_cmos_sensor(0x302A)) == 0XB1){
 				ov8858version2 = OV8858R1A;
				LOG_INF("ov8858version2 = %d(0=r2a,1=r1a)\n",ov8858version2);	
			...
			*sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C))+1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if((read_cmos_sensor(0x302A)) == 0XB2){
 				ov8858version2 = OV8858R2A;
				LOG_INF("i2c write id: 0x%x, sensor id: 0x%x, ov8858version = %d(0=r2a,1=r1a)\n", imgsensor.i2c_write_id,*sensor_id,ov8858version2);	
				return ERROR_NONE;
				}
				...
				#endif
				LOG_INF("i2c write id: 0x%x, sensor id: 0x%x, ov8858version2 = %d(0=r2a,1=r1a)\n", imgsensor.i2c_write_id,*sensor_id,ov8858version2);
				return ERROR_NONE;
			}	
...
{
	int RG_Ratio_Typical = 0x141, BG_Ratio_Typical = 0x125;
	...
	if ((*otp_ptr).flag & 0x40) {
		...
		printk("yuyan>>>AW816_ov8858 WB update success\n");
	}
	...
	if ((*otp_ptr).flag & 0x10) {
		...
		printk("yuyan>>>AW816_ov8858 LSC update success\n");
	}
	return (*otp_ptr).flag;
}
		...
		do {
			...
			if (sensor_id == imgsensor_info.sensor_id) {				
				//LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
                                LOG_INF("i2c write id: 0x%x, sensor id: 0x%x,ov8858version2=0x%x\n", imgsensor.i2c_write_id,sensor_id,ov8858version2);	  
				break;
			}	
			LOG_INF("Read sensor id fail, id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
			retry--;
...
UINT32 OV8858_MIPI_RAW_AW816_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
