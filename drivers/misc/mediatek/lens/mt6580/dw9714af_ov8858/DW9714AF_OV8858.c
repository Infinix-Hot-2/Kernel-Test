...
#define AF_DRVNAME "DW9714AF_OV8858"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x19
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9714af_ov8858"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9714af_ov8858"
...
inline static int moveAF(unsigned long a_u4Position)
{
    ...
    printk("lili>>>>>move [curr] %ld [target] %ld\n", g_u4CurrPosition, g_u4TargetPosition);
	//msleep(2);
            spin_lock(&g_AF_SpinLock);
            g_sr = 3;
            g_i4MotorStatus = 0;
            ...
            {
                printk("lili>>>>set I2C failed when moving the motor \n");
