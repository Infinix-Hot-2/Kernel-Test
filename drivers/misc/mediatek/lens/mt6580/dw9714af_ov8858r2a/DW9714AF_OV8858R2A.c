...
#define AF_DRVNAME "DW9714AF_OV8858R2A"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x22
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9714af_ov8858r2a"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9714af_ov8858r2a"
