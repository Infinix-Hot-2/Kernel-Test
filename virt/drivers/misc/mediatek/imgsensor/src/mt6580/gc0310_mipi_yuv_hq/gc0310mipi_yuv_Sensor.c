...
static void GC0310MIPI_Sensor_Init(void)
{
  ...
  /////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x41,0x25);//21->25
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0310MIPI_write_cmos_sensor(0x82,0x04); //14 red
	GC0310MIPI_write_cmos_sensor(0x83,0x06); //0b red
	...
	//GC0310MIPI_write_cmos_sensor(0xde,0xe4);
	...
	GC0310MIPI_write_cmos_sensor(0xbf,0x05);
	GC0310MIPI_write_cmos_sensor(0xc0,0x12);
	GC0310MIPI_write_cmos_sensor(0xc1,0x2b);
	GC0310MIPI_write_cmos_sensor(0xc2,0x4a);
	GC0310MIPI_write_cmos_sensor(0xc3,0x62);
	GC0310MIPI_write_cmos_sensor(0xc4,0x77);
	GC0310MIPI_write_cmos_sensor(0xc5,0x87);
	GC0310MIPI_write_cmos_sensor(0xc6,0xa1);
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0xd1,0x3d);//3b
	GC0310MIPI_write_cmos_sensor(0xd2,0x3d);
	...
	GC0310MIPI_write_cmos_sensor(0x0c,0x40);//00 red
	GC0310MIPI_write_cmos_sensor(0x12,0x52); 
  GC0310MIPI_write_cmos_sensor(0x13,0x38);//38
	...
	GC0310MIPI_write_cmos_sensor(0x67,0xa2);
  ...
  GC0310MIPI_write_cmos_sensor(0x77,0x48);
	GC0310MIPI_write_cmos_sensor(0x78,0xd0);  //af
...
*/
  ...
  GC0310MIPI_write_cmos_sensor(0x93 ,0xca);
  GC0310MIPI_write_cmos_sensor(0x94 ,0x55);
  GC0310MIPI_write_cmos_sensor(0x95 ,0x15);
  GC0310MIPI_write_cmos_sensor(0x96 ,0xe6);
  GC0310MIPI_write_cmos_sensor(0x97 ,0x43);
  GC0310MIPI_write_cmos_sensor(0x98 ,0x15);
  GC0310MIPI_write_cmos_sensor(0x99 ,0xa6);
  GC0310MIPI_write_cmos_sensor(0x9a ,0x43);
  GC0310MIPI_write_cmos_sensor(0x9b ,0x15);
  GC0310MIPI_write_cmos_sensor(0x9c ,0x8d);
  GC0310MIPI_write_cmos_sensor(0x9d ,0x43);
  GC0310MIPI_write_cmos_sensor(0x9e ,0xaa);
  GC0310MIPI_write_cmos_sensor(0x9f ,0xc7);
  GC0310MIPI_write_cmos_sensor(0xa0 ,0xc8);
  GC0310MIPI_write_cmos_sensor(0xa1 ,0x00);
  ...
  GC0310MIPI_write_cmos_sensor(0xa7 ,0x95);
  GC0310MIPI_write_cmos_sensor(0xa8 ,0x55);
  GC0310MIPI_write_cmos_sensor(0xa9 ,0xd1);
  GC0310MIPI_write_cmos_sensor(0xaa ,0x95);
  GC0310MIPI_write_cmos_sensor(0xab ,0xa3);
  GC0310MIPI_write_cmos_sensor(0xac ,0x7b);
  GC0310MIPI_write_cmos_sensor(0xad ,0x55);
  GC0310MIPI_write_cmos_sensor(0xae ,0xd1);
  GC0310MIPI_write_cmos_sensor(0xaf ,0xa3);
  GC0310MIPI_write_cmos_sensor(0xb0 ,0xd1);
  GC0310MIPI_write_cmos_sensor(0xb1 ,0x9c);
  GC0310MIPI_write_cmos_sensor(0xb2 ,0x55);
  GC0310MIPI_write_cmos_sensor(0xb3 ,0xb7);
  GC0310MIPI_write_cmos_sensor(0xb4 ,0x7f);
  GC0310MIPI_write_cmos_sensor(0xb5 ,0x00);
  GC0310MIPI_write_cmos_sensor(0xb6 ,0x00);
  GC0310MIPI_write_cmos_sensor(0xb7 ,0x05);
  GC0310MIPI_write_cmos_sensor(0xb8 ,0xc8);
  GC0310MIPI_write_cmos_sensor(0xb9 ,0x9f);
...
*/
GC0310MIPI_write_cmos_sensor(0xd0, 0x34);//35 red
GC0310MIPI_write_cmos_sensor(0xd1, 0xfa);//fe red
GC0310MIPI_write_cmos_sensor(0xd2, 0x08);
GC0310MIPI_write_cmos_sensor(0xd3, 0x04);
GC0310MIPI_write_cmos_sensor(0xd4, 0x45);
GC0310MIPI_write_cmos_sensor(0xd5, 0x00);
...
GC0310MIPI_write_cmos_sensor(0xdb, 0xf6);
	...
	GC0310MIPI_write_cmos_sensor(0xc4,0x78);//68//78 red 20150513
	GC0310MIPI_write_cmos_sensor(0xc5,0x40);//48//40 red 20150513
	GC0310MIPI_write_cmos_sensor(0xc6,0x40);//40 red 20150513
	GC0310MIPI_write_cmos_sensor(0xc7,0x28);//28 red 20150513
	GC0310MIPI_write_cmos_sensor(0xc8,0x10);
	GC0310MIPI_write_cmos_sensor(0xc9,0x30);
...
static UINT32 GC0310MIPIGetSensorID(UINT32 *sensorID)
{
	...
	{
		SENSORDB("[camera][wangyang]GPIO_SUB_CAM_ID_PIN：high,is not <huaquan> camera !!!");
		*sensorID = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
    // check if sensor ID correct
    do {
        *sensorID=((GC0310MIPI_read_cmos_sensor(0xf0)<< 8)|GC0310MIPI_read_cmos_sensor(0xf1))+1;
        if (*sensorID == GC0310_HQ_SENSOR_ID)
            break; 
...
static UINT32 GC0310MIPIOpen(void)
{
	...
	for(i=0;i<3;i++)
	{
		sensor_id = ((GC0310MIPI_read_cmos_sensor(0xf0) << 8) | GC0310MIPI_read_cmos_sensor(0xf1)) + 1 ;
		if(sensor_id != GC0310_HQ_SENSOR_ID)  
		{
	...
	GC0310MIPI_Sensor_Init();
        printk("this is gc0310_huaquan module\n");
#ifdef DEBUG_SENSOR_GC0310MIPI  
		struct file *fp; 
		mm_segment_t fs; 
		loff_t pos = 0; 
...
static BOOL GC0310MIPI_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_10:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x4d);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_20:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x5d);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_30:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x6d);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;
		default:
		return FALSE;
...
static void GC0310_HQ_MIPI_get_AEAWB_lock(UINT32 *pAElockRet32,UINT32 *pAWBlockRet32)
{ 
    *pAElockRet32 = 1;
    *pAWBlockRet32 = 1;
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
   ...
   case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO: 
		...
		GC0310_HQ_MIPI_get_AEAWB_lock((UINT32)*(feature_data),(UINT32)*(feature_data+1));	
	break; 
    default:
        break; 
	}
...
UINT32 GC0310MIPI_YUV_HQ_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
