...
#define GPIO_QWERTYSLIDE_EINT_PIN         (GPIO15 | 0x80000000)
...
#endif
#define KPD_SLIDE_EINT		15     //CUST_EINT_KPD_SLIDE_NUM
#define KPD_SLIDE_DEBOUNCE	16     //CUST_EINT_KPD_SLIDE_DEBOUNCE_CN	 /* ms */
#define KPD_SLIDE_POLARITY	0      //CUST_EINT_KPD_SLIDE_POLARITY
#define KPD_SLIDE_SENSITIVE	1      //CUST_EINT_KPD_SLIDE_SENSITIVE
