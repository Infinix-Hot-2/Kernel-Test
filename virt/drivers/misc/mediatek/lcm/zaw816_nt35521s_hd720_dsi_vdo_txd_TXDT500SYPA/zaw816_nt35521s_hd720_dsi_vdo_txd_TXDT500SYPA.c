...
{0xB8,	1,	{0x1F}},// source EQ2

{0xBB,	2,	{0xAA,0XAA}}, //AA AA
...
{0xFF,	4,	{0xAA,0X55,0X25,0X01}}, //VCOM ADJ
{0x6F,	1,	{0x25}},
{0xFA,	1,	{0x0C}},
...
{0xBC,	2,	{0x70,0X00}},//78  // caspar 0xA0
 
{0xBD,	2,	{0x70,0X00}},// caspar 0xA0

{0xCA,	1,	{0x00}},

{0xC0,	1,	{0X0C}},//0C

{0xB5,	2,	{0x05,0X05}},//Modify by NVT_20150805

//{0xBE,	1,	{0x86}},//77  //91  //86

{0xB3,	2,	{0x26,0X26}},//2E

{0xB4,	2,	{0x10,0X10}},//0F//Modify by NVT_20150805

{0xB9,	2,	{0x35,0X35}},

{0xBA,	2,	{0x16,0X16}},//Modify by NVT_20150805
...
//{0xB0,	16,	{0x00,0x00,0x00,0x0E,0x00,0x2A,0x00,0x42,0x00,0x56,0x00,0x7A,0x00,0x96,0x00,0xC6}},
//{0xB1,	16,	{0x00,0xEB,0x01,0x29,0x01,0x59,0x01,0xA5,0x01,0xE3,0x01,0xE5,0x02,0x1F,0x02,0x5D}},
//{0xB2,	16,	{0x02,0x84,0x02,0xB4,0x02,0xD4,0x02,0xFE,0x03,0x17,0x03,0x36,0x03,0x47,0x03,0x57}},
//{0xB3,	4,	{0x03,0x63,0x03,0xFE}},

{0xB0,	16,	{0x00,0x00,0x00,0x03,0x00,0x10,0x00,0x20,0x00,0x32,0x00,0x4B,0x00,0x63,0x00,0x8E}},
{0xB1,	16,	{0x00,0xB0,0x00,0xE9,0x01,0x1D,0x01,0x6E,0x01,0xB4,0x01,0xB5,0x01,0xF6,0x02,0x3E}},
{0xB2,	16,	{0x02,0x6C,0x02,0xAA,0x02,0xD6,0x03,0x0F,0x03,0x32,0x03,0x64,0x03,0x79,0x03,0xC6}},
{0xB3,	4,	{0x03,0xFD,0x03,0xFE}},
...
{0xC0,	1,	{0x0A}},//Modify by NVT_20150805

{0xC1,	1,	{0x08}},//Modify by NVT_20150805
...
{0xB2,	5,	{0x04,0X00,0X00,0X00,0X00}},//Modify by NVT_20150805

{0xB3,	5,	{0x04,0X00,0X00,0X00,0X00}},//Modify by NVT_20150805

{0xB4,	5,	{0x04,0X00,0X17,0X00,0X00}},//Modify by NVT_20150805

{0xB5,	5,	{0x04,0X00,0X17,0X00,0X00}},//Modify by NVT_20150805
...
{0xC8,	2,	{0x06,0X20}},//Modify by NVT_20150805

{0xC9,	2,	{0x02,0X20}},//Modify by NVT_20150805
...
{0xBA,	5,	{0x44,0X00,0X00,0X00,0X00}},//0X02,0XAD//Modify by NVT_20150805

{0xBB,	5,	{0x44,0X00,0X00,0X00,0X00}},//0X02,0XAD//Modify by NVT_20150805

{0xBC,	5,	{0x44,0X00,0X1A,0X00,0X00}},//Modify by NVT_20150805

{0xBD,	5,	{0x44,0X00,0X1A,0X00,0X00}},//Modify by NVT_20150805
...
{0xB0,	16,     {0x00,0x00,0x00,0x58,0x00,0x8B,0x00,0xAB,0x00,0xC2,0x00,0xDA,0x01,0x00,0x01,0x2C}},	
{0xB1,	16,  	{0x01,0x4E,0x01,0x85,0x01,0xAF,0x01,0xF1,0x02,0x27,0x02,0x28,0x02,0x5B,0x02,0x93}},	
{0xB2,	16,  	{0x02,0xB6,0x02,0xE6,0x03,0x08,0x03,0x33,0x03,0x52,0x03,0x81,0x03,0x98,0x03,0xA9}},	
...
//{0xFF,	4,  	{0xAA,0x55,0x25,0x01}}, // for  3 lane
//{0x6F,	1,  	{0x16}},
//{0xF7,	1,  	{0x10}},  
//{0xFF,	4,  	{0xAA,0x55,0x25,0x00}},	
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.HS_TRAIL = 120; //caspar add
...
static void lcm_suspend(void)
{
	...
	dsi_set_cmdq(&data_array, 1, 1);
	MDELAY(100);
	data_array[0] = 0x00621500; // Sleep In
	dsi_set_cmdq(&data_array, 1, 1);
	MDELAY(20);
...
LCM_DRIVER zaw816_nt35521s_hd720_dsi_vdo_txd_TXDT500SYPA_lcm_drv = 
{
    .name			= "zaw816_nt35521s_hd720_dsi_vdo_txd_TXDT500SYPA",
