...
#define AF_DRVNAME "DW9714AF_HQ"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x26
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9714af_hq"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9714af_hq"
...
inline static int moveAF(unsigned long a_u4Position)
{
    ...
    //LOG_INF("huanghuang------>>>>>>move [curr] %ld  [target] %ld\n", g_u4CurrPosition, g_u4TargetPosition);
