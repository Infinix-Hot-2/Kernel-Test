...
struct himax_ldo *himax_ldo;

//int himax_gpio_power_config(struct i2c_client *client,struct himax_ts_data *ts)
int himax_gpio_power_config(struct i2c_client *client,struct himax_i2c_platform_data *pdata)
{
	int error=0;
	int ret;
